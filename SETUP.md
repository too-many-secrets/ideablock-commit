...
Automatically tethers every `git commit` to the Bitcoin blockchain using [Ideablock] (https://ideablock.com) service.

---

## Prerequisites

- An [Ideablock] (https://app.ideablock.com) account (for auth)
